...
//   $('body').prepend(demo);
  ...
  var sheets = {
    orange: $('<link rel="stylesheet" href="../potofolio/css/color-1.css">'),
    red: $('<link rel="stylesheet" href="../potofolio/css/color-2.css">'),
    green: $('<link rel="stylesheet" href=../potofolio/"css/color-3.css">'),
    blue: $('<link rel="stylesheet" href="../potofolio/css/color-4.css">'),
  };
